<template>
  <Layout
    id="list-of-projects"
    description="Work - Olaolu's shelf"
    title="Selected work including open source projects, experimentals and front-end apps by Olaolu"
  >
    ...
    <div class="post__content">
      ...
      <p>
        ...
        GitHub at
        <a target="_blank" href="https://github.com/whizkydee/olaolu.dev"
          >whizkydee/olaolu.dev</a
        >. You can also check out my other open source projects on
        <a href="https://github.com/whizkydee" target="_blank">GitHub</a> or
        download a copy of my <a :href="resumePDF" target="_blank">rèsumè</a>.
      </p>

      <p>
        Also, I'm currently available for remote full-time or contract roles.
        Want us to work together? You can send me a mail at
        <a href="mailto:hello@olaolu.dev">hello@olaolu.dev</a> or
        <a :href="socialProfiles.twitter" target="_blank">reach me on Twitter</a
        >!
      </p>
      ...
      <p>
        ...
        built and probably walk you through interesting parts of the code.
      </p>
    </div>
  </Layout>
</template>
