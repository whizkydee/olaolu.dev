...
export const SITE_TITLE = `${AUTHOR_NAME}: Software Engineer`
export const SITE_DESCRIPTION =
  'Olaolu Olawuyi is a Software Engineer with over 15 years of experience building fast, resilient web platforms, tooling, and scalable systems.'
...
export const SOCIAL_IMAGE = {
  ...
  width: 1730,
  height: 909,
  alt: `${AUTHOR_NAME} — Software Engineer`,
} as const
